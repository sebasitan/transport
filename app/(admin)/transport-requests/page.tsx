      ...
      <div className="bg-white p-6 rounded-[2.5rem] shadow-sm border border-slate-100 flex flex-col md:flex-row items-center justify-between gap-6">
        ...
        <div className="flex items-center gap-3">
          ...
          <div className="relative">
            ...
            <Input
              type="date"
              className="pl-10 h-12 rounded-2xl bg-slate-50 border-none font-bold text-slate-700"
          ...
          {selectedDateFilter && (
            <button
              ...
              className="w-10 h-10 rounded-xl bg-slate-50 flex items-center justify-center hover:bg-red-50 text-slate-400 hover:text-red-400 transition-colors"
              title="Clear Date"
            >
        ...
        {/* Status Filter Tabs */}
        <div className="p-1.5 bg-slate-50 rounded-2xl border border-slate-100 flex items-center gap-1">
        ...
        <div className="flex items-center gap-3">
          <div className="relative">
            ...
            <Input
              ...
              className="pl-10 h-12 bg-slate-50 rounded-2xl border-none focus:ring-2 focus:ring-primary/10 shadow-inner w-[220px]"
              value={search}
              onChange={(e) => setSearch(e.target.value)}
            />
          </div>
          <Select value={serviceTypeFilter} onValueChange={setServiceTypeFilter}>
            <SelectTrigger className="h-12 rounded-2xl bg-slate-50 border-none font-bold w-[160px]">
              <SelectValue placeholder="Service All" />
            </SelectTrigger>
            <SelectContent>
              <SelectItem value="all">Service: All</SelectItem>
              <SelectItem value="pickup">Pickups</SelectItem>
              <SelectItem value="drop">Dropffs</SelectItem>
